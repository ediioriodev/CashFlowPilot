  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <main className="max-w-2xl mx-auto p-4 space-y-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Invita Membri</h1>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-gray-800">Nuovo Invito</h2>
          </div>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-800 px-1">Inviti Attivi</h3>
          ...
          {loadingInvites ? (
            ...
            <div className="bg-white rounded-xl p-8 text-center border border-gray-100 border-dashed">
              ...
              <p className="text-gray-500">Nessun invito attivo al momento.</p>
            </div>
          ) : (
            activeInvites.map((invite) => {
              ...
              return (
                <div 
                  key={invite.id} 
                  className={`bg-white rounded-xl shadow-sm border p-5 transition-all hover:shadow-md relative overflow-hidden ${
                    isExpiringSoon ? 'border-amber-200' : 'border-gray-100'
                  }`}
                >
                  {isExpiringSoon && (
                    <div className="absolute top-0 right-0 bg-amber-100 text-amber-700 text-xs px-2 py-1 rounded-bl-lg font-medium flex items-center gap-1">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <div className="text-2xl font-mono font-bold text-indigo-600 tracking-wider mb-1">
                        {formattedCode}
                      </div>
                  ...
                  {invite.invited_email && (
                     <div className="mb-4 text-sm text-gray-600 bg-gray-50 p-2 rounded inline-block">
                        Per: <span className="font-medium">{invite.invited_email}</span>
                     </div>
                  )}
                  ...
                  <div className="flex gap-2 mt-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 bg-emerald-50 text-emerald-700 py-2 rounded-lg hover:bg-emerald-100 transition-colors text-sm font-medium"
                    >
                    ...
                    <button
                      ...
                      className="flex-none flex items-center justify-center p-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors"
